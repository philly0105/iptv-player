...
class SeriesPage {
    ...
    init() {
        ...
        document.getElementById('series-collapse-btn')?.addEventListener('click', () => {
            document.querySelector('.series-header')?.classList.toggle('controls-collapsed');
        });
    }

    async show() {
        // Restore controls if collapsed
        document.querySelector('.series-header')?.classList.remove('controls-collapsed');
